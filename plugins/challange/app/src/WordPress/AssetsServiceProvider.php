...
class AssetsServiceProvider implements ServiceProviderInterface {
	...
	public function enqueueFrontendAssets() {
		...
		// Enqueue scripts.
		\CoffeeCodeChallange::core()->assets()->enqueueScript(
			'theme-js-bundle',
			\CoffeeCodeChallange::core()->assets()->getBundleUrl( 'frontend', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \CoffeeCodeChallange::core()->assets()->getBundleUrl( 'frontend', '.css' );

		\CoffeeCodeChallange::core()->assets()->enqueueStyle(
			'bulma-bundle',
	...
	public function enqueueAdminAssets() {
		...
		\CoffeeCodeChallange::core()->assets()->enqueueScript(
			...
			\CoffeeCodeChallange::core()->assets()->getBundleUrl( 'admin', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \CoffeeCodeChallange::core()->assets()->getBundleUrl( 'admin', '.css' );
