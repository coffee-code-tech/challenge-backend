...
namespace CoffeeCodeChallange\View;
...
class ViewServiceProvider implements ServiceProviderInterface {
	...
	protected function registerGlobals() {
		 ...
		 */
		// phpcs:ignore
		// \CoffeeCodeChallange::views()->addGlobal( 'foo', 'bar' );
	}
	...
	protected function registerComposers() {
		 ...
		 */
		// phpcs:ignore
		// \CoffeeCodeChallange::views()->addComposer( 'partials/foo', 'FooPartialViewComposer' );
	}
}
