...
class AssetsServiceProvider implements ServiceProviderInterface {
	...
	public function enqueueFrontendAssets() {
		...
		// Enqueue scripts.
		\CoffeeCodeChallenge::core()->assets()->enqueueScript(
			'theme-js-bundle',
			\CoffeeCodeChallenge::core()->assets()->getBundleUrl( 'frontend', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \CoffeeCodeChallenge::core()->assets()->getBundleUrl( 'frontend', '.css' );

		if ( $style ) {
			\CoffeeCodeChallenge::core()->assets()->enqueueStyle(
				'theme-css-bundle',
				$style
			);
		}
	...
	public function enqueueAdminAssets() {
		...
		\CoffeeCodeChallenge::core()->assets()->enqueueScript(
			...
			\CoffeeCodeChallenge::core()->assets()->getBundleUrl( 'admin', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \CoffeeCodeChallenge::core()->assets()->getBundleUrl( 'admin', '.css' );
