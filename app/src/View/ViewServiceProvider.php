...
namespace CoffeeCodeChallenge\View;
...
class ViewServiceProvider implements ServiceProviderInterface {
	...
	protected function registerGlobals() {
		 ...
		 */
		// phpcs:ignore
		// \CoffeeCodeChallenge::views()->addGlobal( 'foo', 'bar' );
	}
	...
	protected function registerComposers() {
		 ...
		 */
		// phpcs:ignore
		// \CoffeeCodeChallenge::views()->addComposer( 'partials/foo', 'FooPartialViewComposer' );
	}
}
